...
A generic OAuth authentication helper for MCPFusion that supports multiple OAuth providers through a modular architecture.
...
- **Google APIs**: Gmail, Calendar, Drive, Photos, YouTube
- **GitHub**: Repositories, Organizations, Packages
- **Microsoft 365**: Outlook, OneDrive, Teams (planned)
- **Dropbox**: File storage and sharing (planned)
...
import "github.com/PivotLLM/MCPFusion/cmd/fusion-oauth/providers"
